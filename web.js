...
'    position: relative;',
'  }',
'  /* 纸面质感：顶部暖光晕 + 角落暖调 + 细纤维颗粒 */',
'  body::before {',
'    content: ""; position: fixed; inset: 0; pointer-events: none; z-index: 0;',
'    background:',
'      radial-gradient(ellipse 90% 55% at 50% 0%, rgba(216,193,152,.30), transparent 62%),',
'      radial-gradient(ellipse 60% 40% at 85% 100%, rgba(198,172,132,.18), transparent 55%),',
'      radial-gradient(ellipse 45% 35% at 8% 92%, rgba(196,168,126,.12), transparent 50%),',
'      radial-gradient(rgba(122,100,66,.055) 1px, transparent 1.3px);',
'    background-size: 100% 100%, 100% 100%, 100% 100%, 5px 5px;',
'  }',
'  /* 树影：阳光透过树冠投在纸上的枝桠剪影，极缓轻摇 */',
'  .tree { position: fixed; top: 0; left: 0; width: 100%; height: 300px; pointer-events: none; z-index: 0; animation: sway 18s ease-in-out infinite alternate; }',
...
'</head>',
'<body>',
'<svg class="tree" viewBox="0 0 1440 300" preserveAspectRatio="xMidYMin slice" aria-hidden="true"><g fill="none" stroke="#332E22" stroke-width="1.1" opacity="0.09" stroke-linecap="round"><path d="M-30 30 Q 150 55 360 28 T 780 48 T 1200 30 T 1470 42"/><path d="M180 46 Q 192 130 216 210 M216 210 Q 226 240 252 258"/><path d="M330 36 Q 340 110 356 170 M356 170 Q 368 200 388 216 M356 170 Q 344 190 326 200"/><path d="M520 40 Q 528 120 540 190 M540 190 Q 556 220 578 236"/><path d="M700 44 Q 706 130 716 200 M716 200 Q 730 232 750 246"/><path d="M880 46 Q 890 140 902 220 M902 220 Q 918 250 940 264"/><path d="M1060 36 Q 1072 120 1086 190 M1086 190 Q 1102 222 1120 238"/><path d="M1240 38 Q 1248 110 1260 170 M1260 170 Q 1274 198 1290 210"/><ellipse cx="205" cy="60" rx="14" ry="5" transform="rotate(-20 205 60)"/><ellipse cx="230" cy="120" rx="12" ry="4.5" transform="rotate(15 230 120)"/><ellipse cx="352" cy="150" rx="13" ry="5" transform="rotate(-12 352 150)"/><ellipse cx="540" cy="120" rx="12" ry="4.5" transform="rotate(18 540 120)"/><ellipse cx="712" cy="140" rx="13" ry="5" transform="rotate(-15 712 140)"/><ellipse cx="900" cy="150" rx="12" ry="4.5" transform="rotate(10 900 150)"/><ellipse cx="1088" cy="130" rx="13" ry="5" transform="rotate(-18 1088 130)"/><ellipse cx="1262" cy="100" rx="12" ry="4.5" transform="rotate(14 1262 100)"/></g></svg>',
'<div class="wrap">',
'  <header>',
